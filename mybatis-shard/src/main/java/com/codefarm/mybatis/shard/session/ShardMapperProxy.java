...
import com.codefarm.mybatis.orm.builder.MappedStatementBuilder;
import com.codefarm.mybatis.orm.keygen.ShardJdbc4KeyGenerator;
import com.codefarm.mybatis.orm.keygen.ShardKeyGenerator;
import com.codefarm.mybatis.orm.keygen.sn.ShardSnGenerator;
...
public class ShardMapperProxy implements InvocationHandler, Serializable
{
    ...
    private void processBefore(MappedStatement ms, Object param)
            throws SQLException
    {
        ShardKeyGenerator shardKeyGenerator = MappedStatementBuilder
                .getShardedKeyGenerators().get(ms.getId());
        ShardSnGenerator shardSnGenerator = MappedStatementBuilder
