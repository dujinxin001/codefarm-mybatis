...
import com.codefarm.mybatis.orm.keygen.sn.SnGenerator;
...
/**
 * Mybatis statement构造器
 * @author zhangjian
 *
 */
public class MappedStatementBuilder extends BaseBuilder
{
    private static final Logger logger = LoggerFactory
            .getLogger(MappedStatementBuilder.class);
